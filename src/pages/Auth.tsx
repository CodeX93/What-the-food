...
import { Utensils, Mail, Lock, Eye, EyeOff, Sparkles, Camera, BarChart3, Zap } from "lucide-react";
...
const Auth = () => {
  ...
  const handleSignUp = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Don't navigate - stay on signup page or show success message
      // User will be redirected after email verification and login
    } catch (error: any) {
      toast({
