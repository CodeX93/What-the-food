...
import { TrendingUp, TrendingDown, Calendar, Flame, Target, BarChart3 } from "lucide-react";
    ...
    const fetchAnalytics = async () => {
      try {
        ...
        const scansThisWeek = scans.filter(
          (scan) => new Date(scan.created_at) >= weekAgo
        ).length;

        const scansThisMonth = scans.filter(
          (scan) => new Date(scan.created_at) >= monthAgo
        ).length;
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Track your nutrition insights and scanning habits
            </p>
          </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">
                    {analytics.totalScans > 0
                      ? Math.round(analytics.totalProtein / analytics.totalScans)
                      : 0}g
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">
                    {analytics.totalScans > 0
                      ? Math.round(analytics.totalCarbs / analytics.totalScans)
                      : 0}g
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold">
                    {analytics.totalScans > 0
                      ? Math.round(analytics.totalFat / analytics.totalScans)
                      : 0}g
                  </span>
                </div>
              </CardContent>
