...
type SharedFoodResultsClientProps = {
  scanId: string;
...
export function SharedFoodResultsClient({
  scanId,
  imageUrl,
  analysis,
  serving,
  createdAt,
}: SharedFoodResultsClientProps) {
  const router = useRouter();
  const { toast } = useToast();

  const scaled = useMemo(() => scaleNutrients(analysis.nutrients, serving), [analysis.nutrients, serving]);
