    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        {Array.from({ length: 6 }).map((_, i) => (
          <Card
            key={`loading-${i}`}
            className="flex h-full flex-col overflow-hidden rounded-2xl border-[0.2rem] border-primary/40 bg-white shadow-[0_25px_60px_-32px_rgba(30,41,59,0.35)] transition-shadow dark:border-primary/60 dark:bg-slate-950 dark:shadow-[0_25px_60px_-30px_rgba(15,23,42,0.6)]"
          >
