...
const WhoIsItFor = () => {
  ...
  return (
    <section
      id="who-is-it-for"
      className="relative w-full bg-white dark:bg-[#000000] transition-colors duration-300 pt-6 sm:pt-8 pb-8 sm:pb-12"
    >
      <div className="container mx-auto px-4 w-full">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-xl sm:text-2xl font-semibold mb-6 text-black dark:text-white">
            Who This Is For
          </h3>
