        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-muted-foreground mb-6">
              WhatTheFood was created to make nutritional information accessible to everyone. We
              believe that understanding what you eat shouldn&apos;t require a nutrition degree.
            </p>
